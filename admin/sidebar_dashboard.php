     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="internship.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Internship Batch</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="companies.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Companies</a>
                        </li>
                        <li>
                        ...
                        <li >
                            <a href="teachers.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> ITP Committe</a>
                        </li>
                        <li >
                            <a href="lecturer.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Lecturer</a>
                        </li>
						<li>
                        ...
                        <li>
                            <a href="email.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Email</a>
                        </li>
						<li>
