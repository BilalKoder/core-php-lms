                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form id="add_student" method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="year" class="input focused" id="focusedInput" type="text" placeholder = "Year" required>
                                          </div>
                                        </div>
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="intake" class="input focused" id="focusedInput" type="text" placeholder = "intake" required>
                                          </div>
                                        </div>
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="dates" class="input focused" id="focusedInput" type="date" placeholder = "dates" required>
                                          </div>
                                        </div>
										<div class="control-group">
                                          <div class="controls">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="email" class="input focused" id="focusedInput" type="email" placeholder = "email" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="cgpa" class="input focused" id="focusedInput" type="text" placeholder = "Current CGPA" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="interest_areas" class="input focused" id="focusedInput" type="text" placeholder = "Interested Areas" required>
                                          </div>
                                        </div>
											<div class="control-group">
                                          <div class="controls">
