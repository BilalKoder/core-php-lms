...
<body id="login">
    <div class="container">
      ...
      <form  action="" name="reset" class="form-signin" method="post">
        <h3 class="form-signin-heading"><i class="icon-lock"></i> Forget Password</h3>
        <input type="email" class="input-block-level" name="email" placeholder="username@email.com" />
        <button name="login" class="btn btn-info" type="submit"><i class="icon-signin icon-"></i> Forget</button>
