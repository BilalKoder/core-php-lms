...
<div class="navbar">
		...
		<li class="active"><a href="index.php"><i class="icon-home"></i>&nbsp;Home</a></li>
			<li class="divider-vertical"></li>
		<li><a href="javascript:void(0)"><i class="icon-info-sign"></i>&nbsp;About</a></li>
			<li class="divider-vertical"></li>
		<li><a href="javascript:void(0)"><i class="icon-calendar"></i>&nbsp;Calendar of Events</a></li>
			<li class="divider-vertical"></li>
		...
		<li><a href="#campuses" data-toggle="modal"><i class="icon-building"></i>&nbsp;Campuses</a></li>
			...
			<li class="divider-vertical"></li>
		<li><a href="javascript:void(0)"><i class="icon-file"></i>&nbsp;History</a></li>
			<li class="divider-vertical"></li>
