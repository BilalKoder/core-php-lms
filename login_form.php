			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to Internship Management System", { header: 'Access Granted' });
									var delay = 1000;
			...
			<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign In as Teacher" id="signin_teacher" onclick="window.location='signup_teacher.php'" name="login" class="btn btn-info" type="submit">I`m a Supervisor</button>
				</div>
				<hr>
				<button data-placement="top" title="Sign In as Student" id="signin_student" onclick="window.location='signup_student.php'" id="btn_student" name="login" class="btn btn-info" type="submit">I`m a ITP Committe</button>
